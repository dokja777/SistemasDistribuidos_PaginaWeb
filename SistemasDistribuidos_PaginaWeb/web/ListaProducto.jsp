  ...
  <style>
    ...
    %>
        ...
        <div class="tabla" style=" width: 70%">
            <div class="titulo">LISTA PRODUCTOS</div>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>${campo.descripcion}</td>
                     ...
                     <td><a href="ControlerProducto?Op=EditarProducto&Id=${campo.idProd}" class="btn btn-primary"><i class="fas fa-edit"></i> Editar</a></td>
                     <!--
                     <td><a href="ControlerProducto?Op=Eliminar&Id=${campo.idProd}" 
